...
`devices/JXD/packages/features/modbus-server.yaml` exposes. Needs only pyserial, which ESPHome
...
# JXD map, see devices/JXD/packages/features/modbus-server.yaml. Coils and discrete inputs share
