...
TEST(JeefsCrc32, ReproducesTheCrcEveryUpstreamVectorShips) {
  ...
  EXPECT_EQ(compute_crc32(V3_HEADER_SECP256R1.data(), CRC_DATA_SIZE), V3_HEADER_SECP256R1_CRC);
...
TEST(JeefsCrc32, TheShippedCrcIsWhatTheVectorStoresAtOffset252) {
  ...
  EXPECT_EQ(get_u32(V3_HEADER_SECP256R1.data(), HDR_OFF_CRC32), V3_HEADER_SECP256R1_CRC);
