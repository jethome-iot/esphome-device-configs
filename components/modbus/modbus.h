...
class ModbusDevice {
 public:
  ...
  virtual void on_modbus_read_coils(uint16_t start_address, uint16_t number_of_coils){};
  virtual void on_modbus_read_discrete_inputs(uint16_t start_address, uint16_t number_of_inputs){};
  virtual void on_modbus_write_coils(uint8_t function_code, const std::vector<uint8_t> &data){};
