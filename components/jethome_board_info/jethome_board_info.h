...
// signature included; nothing is checked beyond the CRCs.
class JetHomeBoardInfo : public Component {
 public:
  ...
  // Cross-check of device.id against the header's USID.
  ...
  // SIGNATURE_SIZE bytes; SIG_NONE means the device was never signed.
